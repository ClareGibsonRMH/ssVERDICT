...
from verdict_data import data_loader
...
my_optim = optim.Adam(net.parameters(), lr = 0.001)
...
net.eval()
with torch.no_grad():
    X_real_pred, f_ic, f_ees, r, d_ees = net(torch.from_numpy(img.astype(np.float32)))